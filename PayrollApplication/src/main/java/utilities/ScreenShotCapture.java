...
public class ScreenShotCapture {    //for capturing screenshot when the test case fails
	public void captureFailureScreenShot(WebDriver driver, String name) throws IOException { // String name here is getName which is the testcase name
