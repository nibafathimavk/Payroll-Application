...
public class Retry implements IRetryAnalyzer {
	...
	private static final int maxTry = 3;    //maxTry=3 here means how many time we need to retry running the failed test cases
	private int count = 0;

	@Override
	public boolean retry(final ITestResult iTestResult) {      //using listener class
